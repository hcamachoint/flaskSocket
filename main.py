...
allow_origin_list = ['https://localhost', 'http://localhost', '127.0.0.1', 'http://localhost:5000', 'http://51.222.24.73:5000']
...
@socketio.on('connect')
def test_connect():
    if request.environ['HTTP_ORIGIN'] in allow_origin_list:
